...
public class InputPoker 
{
        public void poker()
    {
        Giocatore g1 =new GiocatoreUmano("Player1");
        Giocatore g2 = new Giocatore("Palyer2");
        Giocatore g3 =new Giocatore("Player3");
        Giocatore g4 = new Giocatore("Player4");
        Giocatore g5 =new Giocatore("Player5");
        ...
        while(true)
        {
            ...
            */
            do
            {
                ...
                if(input.equals("r"))
                {   
                    //TODO:Bisogna verificare che il Giocatore sia GiocatoreUmano
                    //TODO: bisogna mettere il metodo per rilanciare che sarà in GiocatoreUmano
                }
            }while(piatto.unGiocatoreMenoRilancioGenerale(giocatori, piatto));
